    ...
    >
      <div className="h-[280px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={displayData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
            <defs>
            ...
            <Bar dataKey="androidDownloads" name="Android" fill="url(#androidGrad)" radius={[3, 3, 0, 0]} maxBarSize={16} />
            <Bar dataKey="iosDownloads" name="iOS" fill="url(#iosGrad)" radius={[3, 3, 0, 0]} maxBarSize={16} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </ChartContainer>
